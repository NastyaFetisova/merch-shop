...
-- ============================================
-- Товары (категория 1: Футболки и лонгсливы)
-- ============================================
...
-- Связи категорий (product_id 1-6 → category_id 1)
...
-- ============================================
-- Товары (категория 2: Худи и толстовки)
-- ============================================
...
-- Связи категорий (product_id 7-10 → category_id 2)
INSERT INTO product_categories (product_id, category_id) VALUES 
(7, 2), (8, 2), (9, 2), (10, 2);
...
-- Связи категорий (product_id 11-13 → category_id 3)
INSERT INTO product_categories (product_id, category_id) VALUES 
(11, 3), (12, 3), (13, 3);
...
-- Связи категорий (product_id 14-17 → category_id 4)
INSERT INTO product_categories (product_id, category_id) VALUES 
(14, 4), (15, 4), (16, 4), (17, 4);

-- Размеры для кепок (S, M, L)
INSERT INTO product_sizes (product_id, size_id, quantity) VALUES 
(14, 1, 50), (14, 2, 50), (14, 3, 50),
(16, 1, 50), (16, 2, 50), (16, 3, 50);

-- Размеры для носков (универсальный M)
INSERT INTO product_sizes (product_id, size_id, quantity) VALUES 
(15, 2, 150),
(17, 2, 150);